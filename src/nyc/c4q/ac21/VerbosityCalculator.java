...
public class VerbosityCalculator {
    public static void main(String[] args){
        ...
        try{
            ...
            double MobyVerb = (wordCountMoby/sentCountMoby);
            double DickensVerb = (wordCountDick/sentCountDick);
            ...
            System.out.println("Dicken's verbosity measure is (word count/ sentence count), which equals " + decimalFormat.format(DickensVerb));
            System.out.println("Melville's verbosity measure is (word/sentence count),which equals " + decimalFormat.format(MobyVerb));
        }
